...
<?php
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" palceholder="Provider name" name="provider_name" value=<?php
    if (isset($_POST['provider_name'])){ //Allows to pre-fill the 'provider_name' entry in case the page is reloaded
        echo("'".$_POST['provider_name']."'");
    }
    ?>>
