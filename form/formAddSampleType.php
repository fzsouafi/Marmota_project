      ...
      <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">New Sample Type</h5>
...
<div>
    ...
    for ($i=0;$i<count($id);$i++){ // to display the table rows
        echo('<tr><td>'.$id[$i].'</td><td>'.$name[$i].'</td><td>'.$comment[$i].'</td></tr>'); // Display of an handler with the checkbox to add it in a year
    }
    ?>
    </tbody>
    </table>
