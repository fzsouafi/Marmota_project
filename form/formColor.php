...
<div class="form-group col-md-4">
    <label for="add_name">Name</label>
        <input type="text" class="form-control" placeholder="Name" name="add_name"></div>

<!-- The button of add-->
<div>
        <button type="submit" class="btn btn-primary" value="add_color" name="add_color" method="post">Add</button>
</div>
