        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">New Protocol</h5>
  ...
  <div>
      ...
      <thead>
          <tr>
              ...
              <th>type</th>
              <th>comment</th>
              <th>protocol_file_id</th>
              <th>file_name</th>
          </tr>
      </thead>
      <tbody>
      <?php
       $id=getOrder('protocol','id','id'); // Get all the protocols to diplay it
      ...
      $filename=getJoinFK('filename','protocol','protocol_files','protocol_file_id','id');
      for ($i=0;$i<count($id);$i++){
          echo('<tr><td>'.$id[$i].'</td><td>'.$name[$i].'</td><td>'.$type[$i].'</td><td>'.$comment[$i].'</td><td>'.$protocol_file_id[$i].'</td><td>'.$filename[$i].'</td>'); 
      }
      ?>
      </tbody>
      </table>
