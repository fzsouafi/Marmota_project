  <?php
    ...
    $join="handler JOIN handler_year ON handler.id=handler_year.handler_id WHERE handler_year.year=$last_year ORDER BY handler_year.handler_id";// Join condition
